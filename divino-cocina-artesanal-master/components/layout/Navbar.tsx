  ...
  return (
    ...
    >
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 lg:h-20">
        ...
        <a
          href="#menu"
          className="hidden md:inline-flex items-center px-5 py-2.5 rounded-full bg-[#C4541A] text-white text-sm font-semibold hover:bg-[#a84316] transition-all duration-200 hover:scale-105 motion-reduce:hover:scale-100 shadow-md hover:shadow-lg"
        >
          Reservar Mesa
        </a>
      ...
      {/* Mobile drawer */}
      {open && (
        <div id="mobile-menu" className="md:hidden bg-[#FAF7F2] border-t border-[#2C1810]/10 px-4 pb-6 pt-4">

  ...
  return (
    ...
    >
      <Image
        ...
        className="w-full h-60 md:h-72 object-cover transition-transform duration-500 group-hover:scale-110 motion-reduce:group-hover:scale-100"
      />
      ...
      <div className="absolute inset-0 bg-[#C4541A]/0 group-hover:bg-[#C4541A]/20 transition-all duration-300 flex items-end">
        <p className="w-full text-white text-sm font-medium px-4 py-3 opacity-100 md:opacity-0 md:group-hover:opacity-100 md:group-focus-within:opacity-100 transition-opacity duration-300 bg-gradient-to-t from-[#2C1810]/60 to-transparent">
          {alt}
        </p>
      </div>
    </div>
    ...
    <section id="galeria" className="py-20 lg:py-28 bg-[#FFF8F0]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-[#2C1810]/70 text-base md:text-lg">
